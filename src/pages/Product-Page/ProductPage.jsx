...
import { FilterSection, ProductCard, Loader, Alert } from '../../components';
    ...
    return (
        <main className="product-list">
            ...
            <section className="product-grid grid-4-cols"> 
             { viewAlert && <Alert action={'warning'} closefn={closeAlert} title={'Out of Stock'} description={'The product is currently out of stock'}/>}
                { loader && <Loader/>}
